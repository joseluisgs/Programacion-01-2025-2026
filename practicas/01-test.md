...
**18. En pseudocódigo DAW, la expresión `x += y;` utilizando el operador de asignación compuesta, realiza la siguiente operación:**
a) Asigna el valor de y a x.
b) Resta y de x y asigna el resultado a x.
c) Suma y a x y asigna el resultado a x.
d) Multiplica x por y y asigna el resultado a x.
